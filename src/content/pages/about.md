---
title: About
description: Chirping Astro — a Chirpy-inspired, Astro theme built for writers and tinkerers.
---
...
[Astro](https://astro.build/) — with a
...
- **SEO out of the box** — OpenGraph, Twitter cards, RSS, and a sitemap.
...
social links, posts-per-page, Giscus credentials, and
feature flags. Restart `bun run dev` after editing it.

New posts go in `src/content/posts/`. No language folders or translation metadata are needed.
